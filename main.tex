...
\begin{frame}{Four treatment groups}
\begin{itemize}
  \item \textbf{NR}: No viral inoculation and low quality diet (Rockrose)
  \item \textbf{VR}: IAPV inoculation and low quality diet (Rockrose)
  \item \textbf{NC}: No viral inoculation and high quality diet (Chestnut)
  \item \textbf{VC}: IAPV inoculation and high quality diet (Chestnut)
\end{itemize}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[scale=0.75]{images/GRVenn.png}
\end{figure}
\end{frame}
