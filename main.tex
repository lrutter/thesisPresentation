...
\author[Lindsay Rutter (ISU)]{\Large Exit Seminar\\ Lindsay Rutter\\ \vspace{9mm} \normalsize \textbf{Program of Study Committee:}\\ Dianne Cook (Co-major Professor)\\ Amy Toth (Co-major Professor)\\ Heike Hofmann\\ Daniel Nettleton\\ James Reecy}
...
\begin{figure}
\centering
\includegraphics[scale=0.42]{images/pubMedNorm.png}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
\fbox{\includegraphics[scale=0.47]{images/GRVenn.png}}
\end{figure}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Amy Toth (Co-major Professor)
    \item Dianne Cook (Co-major Professor)
    \item Heike Hofmann
